...
e!=b.css("color","rgba(0, 0, 0, 0.5)").css("color"),b.css("color",e)}catch(c){}return a}()}});d.fx.step.textShadow=function(b){if(!b.init){var e=d(b.elem).get(0).style.fontSize||d(b.elem).css("fontSize");b.begin=h(d(b.elem).get(0).style.textShadow||d(b.elem).css("textShadow"),e);b.end=d.extend({},b.begin,h(b.end,e));b.init=!0}var e=b.elem.style,a;a=b.begin;var c=b.end,b=b.pos,f=[];typeof c.right!="undefined"&&f.push(parseInt(a.right+b*(c.right-a.right))+"px "+parseInt(a.bottom+b*(c.bottom-a.bottom))+
